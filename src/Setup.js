...
function setupSheets() {
  ...
  createIfMissing_(ss, SheetRepo.SHEET.settings, [
    ...
    ['근무표단위', '30', '근무표(/근무표) 시간 단위(분): 30 또는 60'],
  ...
  // 적용일: 이 행이 적용되기 시작하는 날짜. 근무표가 바뀌면 기존 행은 그대로 두고
  //         새 행을 추가한 뒤 적용일에 바뀌는 첫 월요일(예: 2026-08-03)을 적는다 (이력 보존)
  // 점심: '근무'라고 쓰면 점심시간에도 근무 (휴가 계산·근무표에서 점심을 빼지 않음)
